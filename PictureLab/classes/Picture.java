...
public class Picture extends SimplePicture 
{
    ...
    public void mirrorDiagonal()
    {
        ...
        for (int row = 0; row < length; row++)
        {
            for (int col = 0; col < pixels[row].length; col++)
            {
                ...
                bottomPixel = pixels[width - 1 - row][height - 1 - col];
    ...
    public void mirrorHorizontalBotToTop()
    {
        ...
        {
            for (int col = pixels[row].length -1; col >= 0; col--)
            {
                topPixel = pixels[row][col];
                bottomPixel = pixels[length - row][col];
                bottomPixel.setColor(topPixel.getColor());
            }
        } 
    ...
    public void createCollage()
    {
        ...
        Picture one = new Picture("xc.jpg");
        one.mirrorHorizontalBotToTop();
        this.cropAndCopy( one, 2, 151 ,41 , 246, 0 , 0);
        Picture two = new Picture("xc.jpg");
        two.mirrorVerticalRightToLeft();
        this.cropAndCopy( two, 2, 151 ,41 , 246, 330 , 0 );

        Picture three = new Picture("xc.jpg");
        three.mirrorHorizontal();
         this.cropAndCopy( three, 2, 151 ,41 , 246, 0 , 435 );

        Picture four = new Picture("xc.jpg");
        four.zeroRed();
        this.cropAndCopy( four, 2, 151 ,41 , 246, 330 , 435 );
        
        Picture five = new Picture("xc.jpg");
        this.cropAndCopy( five, 2, 151 ,41 , 246, 165 , 220 );
